            ...
            <div class="row">
                <div class="col" style="margin: 0 100px;">
                    <ul class="nav nav-tabs">
                        <li class="nav-item">
                            <a class="nav-link" href="index.php">Batafsil ma'lumot</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="delete.php">Xaridorlar fikrlari</a>
                        </li>

                    </ul>
                    <div>
                        <h1 style="display: flex; justify-content: center; margin-top: 50px;">Mijozlar tomonidan
                            qoldirilgan izohlar</h1><br><br>
                        <div style="display: flex; justify-content: center; margin-bottom: 100px;">
                            Ushbu mahsulotga izohlar hali qoldirilmagan.
                        </div>
                    </div>
                </div>
        </footer>
